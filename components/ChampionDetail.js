    ...
    return (
      <View style={styles.statsContainer}>
        <View style={styles.statsGrid}>
          <View style={styles.statItem}><Text style={styles.statText}>HP: {hp.toFixed(0)}{buildBonuses.hp ? ` (${buildBonuses.hp} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>MP: {mp.toFixed(0)}{buildBonuses.mp ? ` (${buildBonuses.mp} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>Armor: {armor.toFixed(0)}{buildBonuses.armor ? ` (${buildBonuses.armor} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>MR: {spellblock.toFixed(0)}{buildBonuses.spellblock ? ` (${buildBonuses.spellblock} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>AD: {attackDamage.toFixed(0)}{buildBonuses.attackDamage ? ` (${buildBonuses.attackDamage} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>AS: {attackSpeed.toFixed(2)}{buildBonuses.attackSpeed ? ` (${(buildBonuses.attackSpeed * 100).toFixed(0)}% d'items)` : ''}</Text></View>
          ...
          <View style={styles.statItem}><Text style={styles.statText}>HP Regen: {hpRegen.toFixed(1)}{buildBonuses.hpRegen ? ` (${buildBonuses.hpRegen} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>MP Regen: {mpRegen.toFixed(1)}{buildBonuses.mpRegen ? ` (${buildBonuses.mpRegen} d'items)` : ''}</Text></View>
          <View style={styles.statItem}><Text style={styles.statText}>Crit: {crit.toFixed(0)}%{buildBonuses.crit ? ` (${buildBonuses.crit}% d'items)` : ''}</Text></View>
